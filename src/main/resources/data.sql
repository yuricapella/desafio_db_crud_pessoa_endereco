...
VALUES
    ('Rua A', '123', 'Bairro X', 'Cidade Y', 'SP', '12345678', TRUE, 1, NOW()),
    ('Rua B', '456', 'Bairro Z', 'Cidade W', 'RJ', '23456789', FALSE, 1, NOW()),
    ('Rua C', '789', 'Bairro Y', 'Cidade V', 'MG', '34567890', TRUE, 2, NOW()),
    ('Rua D', '101', 'Bairro W', 'Cidade U', 'BA', '45678901', FALSE, 3, NOW());
